...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function withHeadersIf($condition, $headers)
        {
                        return \Illuminate\Http\Client\PendingRequest::withHeadersIf($condition, $headers);
        }
...
namespace  { 
            ...
            class LaravelSchema extends \WyattCast44\LaravelSchema\Facades\LaravelSchema {}
