        ...
        <form action="{{ route('posts.store') }}" method="POST">
            ...
            <div class="max-w-2xl mx-4 mt-10 mb-16 lg:mx-auto">
                ...
                <label for="title" class="flex flex-col mt-8 space-y-2">
                    ...
                    <input type="text" id="title" name="title" placeholder="Your post title" class="rounded-sm focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-purple-500 focus:ring-offset-purple-200 focus:border-gray-300" autocomplete="off" spellcheck="false" required value="{{ old('title') }}">
                ...
                <label for="excerpt" class="flex flex-col mt-8 space-y-2">
                    ...
                    <textarea id="excerpt" name="excerpt" placeholder="A quick recap of what this post is about, 240 chars or less" class="border-gray-400 rounded-sm focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-purple-500 focus:ring-offset-purple-200 focus:border-gray-300">{{ old('excerpt') }}</textarea>
